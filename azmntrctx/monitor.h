...
private:	// User declarations
    ...
    bool __fastcall SalvarOcorrencia(WORD wNrEvento, DWORD dwCodificador, AnsiString szStatus,
    ...
    void __fastcall SalvarCTX();
    void __fastcall SalvarUltimoEventoCTX();        
    bool __fastcall InterpretaRetornoDll(BYTE erro);
    AnsiString __fastcall GetValorParametro(int CdParametro);
...
MONITOR AnsiString PARAMSISISTEMA_SETORIZACAO;
#endif